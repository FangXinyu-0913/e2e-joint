...
from utils.dataset import NCaltech101,FallDown_ActionRec
from utils.degrade import fd_Net
...
def FLAGS():
    ...
    parser.add_argument("--validation_dataset", default="N-Caltech101/validation/")#, required=True)
    parser.add_argument("--training_dataset", default="N-Caltech101/training/")#, required=True)

    # parser.add_argument("--validation_dataset", default="FallDown_ActionRecognition/validation/")#, required=True)
    # parser.add_argument("--training_dataset", default="FallDown_ActionRecognition/train/")##, required=True)
    # parser.add_argument("--validation_dataset", default="FallDown_ActionRecognition_new/validation/")#, required=True)
    # parser.add_argument("--training_dataset", default="FallDown_ActionRecognition_new/train/")##, required=True)

    # logging options
    parser.add_argument("--log_dir", default="log/fd_new/")#, required=True)
    # parser.add_argument("--log_dir", default="log/temp")#, required=True)
...
if __name__ == '__main__':
    ...
    # training_dataset = FallDown_ActionRec(flags.training_dataset, augmentation=True)
    ...
    # validation_dataset =  FallDown_ActionRec(flags.validation_dataset)
    ...
    for i in range(flags.num_epochs):
        ...
        for events, labels in tqdm.tqdm(training_loader):
            ...
            # print("main model weight and grad")

            # for layer,param in model.state_dict().items(): # param is weight or bias(Tensor)
            #     grad_file = open('/archive/hot0/fxy/rpg_event_representation_learning/output_grad_weight/train_grad.txt', 'a')
                
            #     grad_file.write('epoch:{}\n'.format(i))
            #     grad_file.write('before train and downgrade \n')
            #     grad_file.write('layer{}\n  weight or bias:{}\n'.format(layer,param))
                # print(layer,param)   
            ...
            # print("downgrad net weight and grad")
            ...
            # for layer,param in model.state_dict().items(): # param is weight or bias(Tensor)
            #     grad_file = open('/archive/hot0/fxy/rpg_event_representation_learning/output_grad_weight/downgrad_train_grad.txt', 'a')
                
            #     grad_file.write('epoch:{}\n'.format(i))
            #     grad_file.write('before downgrade \n')
            #     grad_file.write('layer{}\n  weight or bias:{}\n'.format(layer,param))
            ...
            #     grad_file.write('epoch:{}\n'.format(i))
            #     grad_file.write('after downgrade \n')
            #     grad_file.write('layer{}\n  weight or bias:{}\n'.format(layer,param))
            ...
            #     grad_file.write('epoch:{}\n'.format(i))
            #     grad_file.write('after backward and step \n')
            #     grad_file.write('layer{}\n  weight or bias:{}\n'.format(layer,param))
